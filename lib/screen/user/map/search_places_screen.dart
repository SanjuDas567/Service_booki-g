...
// const kGoogleApiKey = 'AIzaSyAMvEs5gM0HkkgWB0c4CkAgf9KLfYhMcyQ';
...
late GoogleMapProvider googleMapProvider;
  ...
  Future<void> _handlePressButton() async {
    Prediction? p = await PlacesAutocomplete.show(
        context: context,
        apiKey: googleMapProvider.kGoogleApiKey,
        onError: onError,
        mode: _mode,
        language: 'en',
        strictbounds: false,
  ...
  Future<void> displayPrediction(Prediction p, ScaffoldState? currentState) async {
    ...
    markersList.add(Marker(markerId: const MarkerId("0"),position: LatLng(lat, lng),infoWindow: InfoWindow(title: detail.result.name)));
     ...
     googleMapProvider.googleMapController.animateCamera(CameraUpdate.newLatLngZoom(LatLng(lat, lng), 14.0));
