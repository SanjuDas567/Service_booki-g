...
class _ProfileScreenWorkerState extends State<ProfileScreenWorker> {
  ...
  final workerId = Provider.of<AuthProviderWorker>(context,listen: false).getWorkerId();
  print(workerId);
    Provider.of<ProfileProviderWorker>(context,listen: false).getWorkerDetails(workerId);
  }
}
