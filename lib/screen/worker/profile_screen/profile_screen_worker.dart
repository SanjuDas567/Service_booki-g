...
class _ProfileScreenWorkerState extends State<ProfileScreenWorker> {
  ...
  late ProfileProviderWorker profileProviderWorker;
  late dynamic workerId;
  @override
  void initState() {
    profileProviderWorker = Provider.of<ProfileProviderWorker>(context, listen: false);
   workerId =
                        ...
                        child: Column(
                          children: [
                                    ...
                                    onPressed: () {
                                      Navigator.push(
                                        ...
                                        MaterialPageRoute(
                                          builder: (context) =>
                                              WorkerEditProfile(
                                            screen: profileProviderWorker
                                                .screen![0],
                                            workerCard: profileProviderWorker
                                                .workerCard![0],
                                          ),
                                        ),
                                      );
                              ...
                              child: ClipRRect(
                                  ...
                                  child: Image.network(
                                    AppConstants.BASE_URL +
                                        profileProviderWorker
                                            .screen![0].empProfilePic,
                            ...
                            CustomFieldProfileWorker(
                              name:
                                  profileProviderWorker.workerCard![0].empName,
                              title: 'Name',
                            ),
                            SizedBox(
                              height: 20,
                            ...
                            CustomFieldProfileWorker(
                              name:
                                  profileProviderWorker.screen![0].empLocation,
                              title: 'Location',
                            ),
                            SizedBox(
                              height: 20,
  ...
  void getworkerData() async {
    ...
    print(workerId);
        ...
        profileProviderWorker.getWorkerDetails(workerId);
  }
}
