class Dimensions {
  ...
  static const double ICONS_DRAWER_HEIGHT = 30.0;
  static const double ICONS_DRAWER_WIDTH = 30.0;

  static const double ICONS_DRAWER_SUB_HEIGHT = 20.0;
  static const double ICONS_DRAWER_SUB_WIDTH = 20.0;
